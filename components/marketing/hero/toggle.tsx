...
const BlueToggle = React.forwardRef<HTMLInputElement, React.InputHTMLAttributes<HTMLInputElement>>(
    ({ className, ...props }, ref) => {
        return (
            <input
                type="checkbox"
                ...
                className={cn(
                    ...
                    "checked:bg-primary checked:before:translate-x-full checked:before:border-[#2218de]",
...
BlueToggle.displayName = "BlueToggle"

export { MinimalToggle, BlueToggle }