...
export default function PositionControl() {
    ...
    return (
        <div
            className={`relative grid h-40 border-spacing-8 grid-cols-3 overflow-hidden rounded-lg border border-border bg-formDark p-1 md:max-w-full [&>*]:cursor-pointer [&>*]:border-dashed [&>*]:border-border [&>*]:transition-colors ${selectedImage ? '' : 'pointer-events-none opacity-40'
                }`}
        >
            <button
